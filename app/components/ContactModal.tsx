...
export function ContactModal({ onClose }: ContactModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <Card variant="elevated" className="w-full max-w-md p-6 relative">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="space-y-3 mb-6">
          {/* Email */}
          <a
            href="mailto:ethantaylan@gmail.com?subject=Scrum%20Poker%20Feedback"
          ...
          >
            <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 group-hover:bg-blue-100 dark:group-hover:bg-blue-900 transition-colors">
              <svg className="w-5 h-5 text-gray-600 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            </div>
          ...
          {/* GitHub */}
          <a
            href="https://github.com/ethantaylan/scrum/issues"
            target="_blank"
